...
import 'advanced_data_table_src.dart';

/// This is the settings used for the paginator of [UTOLDataTable].
///
/// Usage:
///
/// ```dart
...
class DataTablePaginatorSettings {
  ...
  /// This is used when the user wants to show the jump to the first or last page of the [UTOLDataTable].
  ///
